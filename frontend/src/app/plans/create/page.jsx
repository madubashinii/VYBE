        ...
        <div className="min-h-screen bg-gradient-to-br from-[#070b1a] via-[#0b132b] to-[#111b38]">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-[#101a37]/90 backdrop-blur-xl rounded-2xl shadow-xl p-6 sm:p-8 border border-[#2a3d6a] mb-6">
                    ...
                    <div className="mb-8">
                        <h2 className="text-[#e7eefc] text-xl font-bold mb-4">Plan Details</h2>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-[#e7eefc] text-sm font-semibold mb-2">Plan Name</label>
                                <input
                                    type="text"
                                    value={planData.name}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-[#e7eefc] text-sm font-semibold mb-2">Duration</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-[#e7eefc] text-sm font-semibold mb-2">Difficulty</label>
                                    <select
                            ...
                            <div>
                                <label className="block text-[#e7eefc] text-sm font-semibold mb-2">Goal</label>
                                <select
                                    value={planData.goal}
                            ...
                            <div>
                                <label className="block text-[#e7eefc] text-sm font-semibold mb-2">Description</label>
                                <textarea
                                    value={planData.description}
                                    onChange={(e) => setPlanData({ ...planData, description: e.target.value })}
                                    placeholder="Describe your workout plan..."
                                    rows="3"
                                    className="w-full px-4 py-3 bg-[#0b1228] border-2 border-[#2a3d6a] rounded-xl text-[#e7eefc] focus:border-[#ff6a00] outline-none resize-none"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-6">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-[#e7eefc] text-xl font-bold">Exercises</h2>
                            <button
                                type="button"
                                onClick={addExercise}
                                className="bg-gradient-to-r from-[#ff6a00] to-[#ff9e1a] text-white px-4 py-2 rounded-xl font-semibold hover:shadow-lg transition-all"
                            >
                                + Add Exercise
                            </button>
                        </div>
                        ...
                        <div className="space-y-4">
                            {exercises.map((exercise, index) => (
                                <div key={exercise.id} className="bg-[#2a3d6a]/20 rounded-xl p-4 border-2 border-[#2a3d6a]/50">
                                    <div className="flex items-center justify-between mb-3">
                                        <span className="text-[#e7eefc] font-bold text-sm">Exercise #{index + 1}</span>
                                        {exercises.length > 1 && (
                                            <button
                                                type="button"
                                    ...
                                    <div className="space-y-3">
                                        <select
                                            ...
                                            className="w-full px-3 py-2 text-sm bg-[#0b1228] border-2 border-[#2a3d6a] rounded-lg text-[#e7eefc] focus:border-[#ff6a00] outline-none"
                                        >
